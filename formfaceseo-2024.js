...
formdiv+= ' <li class="sss-form-control gfield thanhan">              <div class="sss-form-control-inner">                                <div class="ginput_container">                  <input class="medium" name="entry.'+duan+'" maxlength="15" id="your_phone" placeholder="Nhu Cầu" value="'+linkhientai+'" length="11" type="tel">                </div>              </div>            </li>';
